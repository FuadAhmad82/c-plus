...
int main()
{
	...
	cout << "Cost: $" << (price_per_sroom * number_of_srooms) +
		(price_per_lroom * number_of_lrooms)
		<< endl;

	cout << "Tax: $" << (price_per_sroom * number_of_srooms* sales_tax) +
		(price_per_lroom * number_of_lrooms * sales_tax)
		<< endl;

	cout << "====================" << endl;
	cout << "Totsal estimate : $" << (number_of_srooms * price_per_sroom) +
		(number_of_lrooms * price_per_lroom) + 
		(price_per_sroom * number_of_srooms* sales_tax) + 
		(price_per_lroom * number_of_lrooms * sales_tax) 
		<< endl;
